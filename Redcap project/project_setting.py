        ...
        for key in project_list.keys():
            ...
            if project_list[key] != None:
                for value, project_id in zip(project_list[key]['redcap_project_name'], project_list[key]['project_id']):
                    ...
                    self.btn_delete = ctk.CTkButton(self.inner_frame, text=None, width=30, fg_color="transparent", image=self.delete_image, command=partial(delete_project, master, project_id))
